...
def atmospheric_density_and_oxygen(altitude, co2_surface_vol, co2_lower, co2_upper):
    ...
    Returns:
        ...
        rho_o - total oxygen radical density [kg m-3]
        rho_co2 - total co2 density
    """
    ...
    rho_a_data = [1.21e+00, 1.09e+00, 9.84e-01, 8.90e-01, 8.05e-01, 7.28e-01, 6.57e-01, 5.90e-01, 5.28e-01, 4.70e-01, 4.15e-01, 3.65e-01, 
                  3.19e-01, 2.77e-01, 2.39e-01, 2.06e-01, 1.76e-01, 1.50e-01, 1.28e-01, 1.09e-01, 9.23e-02, 7.86e-02, 6.69e-02, 5.70e-02, 
                  4.86e-02, 4.15e-02, 3.55e-02, 3.03e-02, 2.59e-02, 2.22e-02, 1.90e-02, 1.63e-02, 1.39e-02, 1.20e-02, 1.03e-02, 8.84e-03, 
                  7.63e-03, 6.60e-03, 5.72e-03, 4.97e-03, 4.32e-03, 3.77e-03, 3.30e-03, 2.89e-03, 2.54e-03, 2.24e-03, 1.98e-03, 1.75e-03, 
                  1.55e-03, 1.37e-03, 1.22e-03, 1.08e-03, 9.60e-04, 8.53e-04, 7.58e-04, 6.74e-04, 5.98e-04, 5.31e-04, 4.71e-04, 4.17e-04,
                  3.69e-04, 3.26e-04, 2.88e-04, 2.53e-04, 2.23e-04, 1.96e-04, 1.71e-04, 1.50e-04, 1.31e-04, 1.14e-04, 9.88e-05, 8.57e-05,
                  7.41e-05, 6.37e-05, 5.50e-05, 4.74e-05, 4.08e-05, 3.51e-05, 3.00e-05, 2.55e-05, 2.16e-05, 1.82e-05, 1.53e-05, 1.27e-05,
                  1.05e-05, 8.67e-06, 7.10e-06, 5.79e-06, 4.69e-06, 3.79e-06, 3.05e-06, 2.45e-06, 1.96e-06, 1.57e-06, 1.26e-06, 1.01e-06,
                  8.20e-07, 6.65e-07, 5.43e-07, 4.47e-07, 3.70e-07, 3.09e-07, 2.60e-07, 2.21e-07, 1.88e-07, 1.61e-07, 1.38e-07, 1.19e-07,
                  1.03e-07, 8.90e-08, 7.70e-08, 6.66e-08, 5.77e-08, 4.99e-08, 4.33e-08, 3.76e-08, 3.27e-08, 2.86e-08, 2.50e-08, 2.19e-08,
                  1.93e-08, 1.70e-08, 1.51e-08, 1.34e-08, 1.20e-08, 1.08e-08, 9.76e-09, 8.87e-09, 8.09e-09, 7.41e-09, 6.81e-09, 6.28e-09,
                  5.81e-09, 5.38e-09, 5.00e-09, 4.66e-09, 4.36e-09, 4.08e-09, 3.82e-09, 3.59e-09, 3.38e-09, 3.18e-09, 3.00e-09, 2.84e-09,
                  2.69e-09, 2.55e-09, 2.42e-09, 2.30e-09, 2.18e-09, 2.08e-09, 1.98e-09, 1.89e-09, 1.81e-09, 1.72e-09, 1.65e-09, 1.58e-09,
                  1.51e-09, 1.45e-09, 1.39e-09, 1.33e-09, 1.28e-09, 1.23e-09, 1.18e-09, 1.14e-09, 1.10e-09, 1.06e-09, 1.02e-09, 9.82e-10,
                  9.47e-10, 9.14e-10, 8.83e-10, 8.53e-10, 8.24e-10, 7.96e-10, 7.70e-10, 7.45e-10, 7.21e-10, 6.98e-10, 6.76e-10, 6.55e-10,
                  6.35e-10, 6.16e-10, 5.97e-10, 5.79e-10, 5.62e-10, 5.46e-10, 5.30e-10, 5.14e-10, 5.00e-10, 4.86e-10, 4.72e-10]

    ratio = (co2_upper-co2_surface_vol)/(co2_upper-co2_lower) #get the ratio that for lower ones directly
    #print('upper:',co2_upper,'lower:',co2_lower, 'ratio:',ratio, 'co2_surface:', co2_surface_vol)
    #print(co2_upper * (1-ratio)+(ratio)*co2_lower)
    # read the file
    read_co2 = './Photochem/photochem_180K_1e5_CH4low/'
    ...
    o_value   = co2_lower_file['O']   * ratio + co2_upper_file['O'] * (1 - ratio) 
    o2_value =  2*(co2_lower_file['O2'] * (ratio) + co2_upper_file['O2'] * (1-ratio))
    
    # make calculate the mass density
    co2_value_wt = co2_value*44/(co2_value*44+o_value*16+o2_value*16+(1-co2_value-o_value)*28)
    o_value_wt = o_value*16/(co2_value*44+o_value*16+o2_value*16+(1-co2_value-o_value)*28)
    o2_value_wt = o2_value*32/(co2_value*44+o_value*16+o2_value*16+(1-co2_value-o_value)*28)
    #print(co2_lower_file, ratio,co2_upper_file)
